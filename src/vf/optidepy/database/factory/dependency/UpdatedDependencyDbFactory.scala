...
object UpdatedDependencyDbFactory 
	extends CombiningFactory[UpdatedDependency, Dependency, DependencyUpdate] with Deprecatable
{
	// IMPLEMENTED	--------------------
	...
	override def apply(dependency: Dependency, update: DependencyUpdate) = UpdatedDependency(dependency, 
		update)
}
